...
export interface Transaction {
  ...
  const transactions: Transaction[] = [
    {th1: 1, th2: 'Loreum Ipsum', th3: ''},
    {th1: 2, th2: 'Loreum Ipsum', th3: ''},
    {th1: 3, th2: 'Loreum Ipsum', th3: ''},
    {th1: 4, th2: 'Loreum Ipsum', th3: ''},
    {th1: 5, th2: 'Loreum Ipsum', th3: ''},
    {th1: 6, th2: 'Loreum Ipsum', th3: ''},
  ];
@Component({
    selector   : 'adminforms12-card',
    templateUrl: './adminforms12.component.html',
    styleUrls  : ['./adminforms12.component.scss']
})
export class Adminforms12Component
{
@ViewChild(MatPaginator) paginator: MatPaginator;
    ...
    displayedColumns: string[] = ['th1', 'th2','th3'];
