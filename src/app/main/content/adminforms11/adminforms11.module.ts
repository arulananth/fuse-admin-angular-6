...
import { Adminforms11Component } from './adminforms11.component';
...
const routes = [
    {
        path     : 'adminforms11',
        component: Adminforms11Component
    }
];

@NgModule({
    declarations: [
        Adminforms11Component,AdminformDialogComponent,AdminformDialog1Component,AdminformDialog2Component
    ...
    exports     : [
        Adminforms11Component
    ]
})

export class Adminforms11Module
{
}
