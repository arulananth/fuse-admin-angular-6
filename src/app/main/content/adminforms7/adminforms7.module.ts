...
import { Adminforms7Component } from './adminforms7.component';
...
const routes = [
    {
        path     : 'adminforms7',
        component: Adminforms7Component
    }
];

@NgModule({
    declarations: [
        Adminforms7Component,AdminformDialogComponent,AdminformDialog1Component,AdminformDialog2Component,AdminformDialog3Component,AdminformDialog4Component,AdminformDialog5Component
    ...
    exports     : [
        Adminforms7Component
    ]
})

export class Adminforms7Module
{
}
