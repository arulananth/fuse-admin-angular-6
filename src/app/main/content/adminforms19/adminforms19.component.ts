...
export interface Transaction {
  ...
  const transactions: Transaction[] = [
    {th1: 1, th2: 'Loreum Ipsum', th3: 'Loreum Ipsum', th4:'Loreum Ipsum', th5:'Loreum Ipsum', th6:'Loreum Ipsum', th7:''},

  ];
@Component({
    selector   : 'adminforms19-card',
    templateUrl: './adminforms19.component.html',
    styleUrls  : ['./adminforms19.component.scss']
})
export class Adminforms19Component
{
