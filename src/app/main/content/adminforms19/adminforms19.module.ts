...
import { Adminforms19Component } from './adminforms19.component';
...
const routes = [
    {
        path     : 'adminforms19',
        component: Adminforms19Component
    }
];

@NgModule({
    declarations: [
        Adminforms19Component,AdminformDialogComponent,AdminformDialog1Component,AdminformDialog2Component
    ...
    exports     : [
        Adminforms19Component
    ]
})

export class Adminforms19Module
{
}
