...
import { Adminforms26Component } from './adminforms26.component';
...
const routes = [
    {
        path     : 'adminforms26',
        component: Adminforms26Component
    }
];

@NgModule({
    declarations: [
        Adminforms26Component,AdminformDialogComponent,AdminformDialog1Component,AdminformDialog2Component
    ...
    exports     : [
        Adminforms26Component
    ]
})

export class Adminforms26Module
{
}
