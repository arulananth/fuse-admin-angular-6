...
import { Adminforms15Component } from './adminforms15.component';
...
const routes = [
    {
        path     : 'adminforms15',
        component: Adminforms15Component
    }
];

@NgModule({
    declarations: [
        Adminforms15Component,AdminformDialogComponent,AdminformDialog1Component,AdminformDialog2Component
    ...
    exports     : [
        Adminforms15Component
    ]
})

export class Adminforms15Module
{
}
