...
import { Adminforms13Component } from './adminforms13.component';
...
const routes = [
    {
        path     : 'adminforms13',
        component: Adminforms13Component
    }
];

@NgModule({
    declarations: [
        Adminforms13Component,AdminformDialogComponent,AdminformDialog1Component,AdminformDialog2Component
    ...
    exports     : [
        Adminforms13Component
    ]
})

export class Adminforms13Module
{
}
