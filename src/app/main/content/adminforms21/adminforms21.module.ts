...
import { Adminforms21Component } from './adminforms21.component';
...
const routes = [
    {
        path     : 'adminforms21',
        component: Adminforms21Component
    }
];

@NgModule({
    declarations: [
        Adminforms21Component,AdminformDialogComponent,AdminformDialog1Component,AdminformDialog2Component
    ...
    exports     : [
        Adminforms21Component
    ]
})

export class Adminforms21Module
{
}
