...
import { Adminforms2Component } from './adminforms2.component';
...
const routes = [
    {
        path     : 'adminforms2',
        component: Adminforms2Component
    }
];

@NgModule({
    declarations: [
        Adminforms2Component,AdminformDialogComponent,AdminformDialog1Component,AdminformDialog2Component
    ...
    exports     : [
        Adminforms2Component
    ]
})

export class Adminforms2Module
{
}
