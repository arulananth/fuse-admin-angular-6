...
import { Adminforms3Component } from './adminforms3.component';
...
const routes = [
    {
        path     : 'adminforms3',
        component: Adminforms3Component
    }
];

@NgModule({
    declarations: [
        Adminforms3Component,AdminformDialogComponent,AdminformDialog1Component,AdminformDialog2Component
    ...
    exports     : [
        Adminforms3Component
    ]
})

export class Adminforms3Module
{
}
