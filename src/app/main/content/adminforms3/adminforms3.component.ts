...
export interface Transaction {
  ...
  const transactions: Transaction[] = [
    ...
    {th1: 4, th2: 'Loreum Ipsum', th3: '',th4: ''},
...
@Component({
    selector   : 'adminforms3-card',
    templateUrl: './adminforms3.component.html',
    styleUrls  : ['./adminforms3.component.scss']
})
export class Adminforms3Component
{
