...
import { Adminforms1Component } from './adminforms1.component';
...
const routes = [
    {
        path     : 'adminforms1',
        component: Adminforms1Component
    }
];

@NgModule({
    declarations: [
        Adminforms1Component,AdminformDialogComponent,AdminformDialog1Component,AdminformDialog2Component
    ...
    exports     : [
        Adminforms1Component
    ]
})

export class Adminforms1Module
{
}
