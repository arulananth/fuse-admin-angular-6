...
import { Adminforms9Component } from './adminforms9.component';
...
const routes = [
    {
        path     : 'adminforms9',
        component: Adminforms9Component
    }
];

@NgModule({
    declarations: [
        Adminforms9Component,AdminformDialogComponent,AdminformDialog1Component,AdminformDialog2Component
    ...
    exports     : [
        Adminforms9Component
    ]
})

export class Adminforms9Module
{
}
