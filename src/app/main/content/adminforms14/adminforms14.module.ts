...
import { Adminforms14Component } from './adminforms14.component';
...
const routes = [
    {
        path     : 'adminforms14',
        component: Adminforms14Component
    }
];

@NgModule({
    declarations: [
        Adminforms14Component,AdminformDialogComponent,AdminformDialog1Component,AdminformDialog2Component
    ...
    exports     : [
        Adminforms14Component
    ]
})

export class Adminforms14Module
{
}
