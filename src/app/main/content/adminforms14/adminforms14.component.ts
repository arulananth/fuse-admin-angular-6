...
export interface Transaction2{
 ...
 const transactions2: Transaction2[] = [
    {th1: 2, th2: 'Loreum Ipsum'},
    {th1: 2, th2: 'Loreum Ipsum'},
   ]
  const transactions: Transaction[] = [
    {th1: 2, th2: 'Loreum Ipsum', th3: 'Loreum Ipsum',th4: 'Loreum Ipsum',th5: 'Loreum Ipsum',th6: 'Loreum Ipsum'},
    {th1: 2, th2: 'Loreum Ipsum', th3: 'Loreum Ipsum',th4: 'Loreum Ipsum',th5: 'Loreum Ipsum',th6: 'Loreum Ipsum'},
    {th1: 2, th2: 'Loreum Ipsum', th3: 'Loreum Ipsum',th4: 'Loreum Ipsum',th5: 'Loreum Ipsum',th6: 'Loreum Ipsum'},
    {th1: 2, th2: 'Loreum Ipsum', th3: 'Loreum Ipsum',th4: 'Loreum Ipsum',th5: 'Loreum Ipsum',th6: 'Loreum Ipsum'},
  ];
    ...
    {th1: 2, th2: 'Loreum Ipsum', th3: 'Loreum Ipsum',th4: 'Loreum Ipsum',th5: 'Loreum Ipsum',th6: 'Loreum Ipsum',th7: 'Loreum Ipsum',th8: 'Loreum Ipsum',th9: 'Loreum Ipsum'},

  ];
@Component({
    selector   : 'adminforms14-card',
    templateUrl: './adminforms14.component.html',
    styleUrls  : ['./adminforms14.component.scss']
})
export class Adminforms14Component
{
@ViewChild(MatPaginator) paginator: MatPaginator;
    imgs:any;
    preview: boolean = false;
    displayedColumns2: string[] = ['th1', 'th2']
    displayedColumns1: string[] = ['th1', 'th2','th3','th4','th5','th6','th7','th8','th9'];
    displayedColumns: string[] = ['th1', 'th2','th3','th4','th5','th6'];
    dataSource = new MatTableDataSource<Transaction>(transactions);
    dataSource1 = new MatTableDataSource<Transaction1>(transactions1);
    dataSource2 = new MatTableDataSource<Transaction2>(transactions2);
        ngOnInit() {
